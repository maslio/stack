...
const { createItem: createSale, updateItem: updateSale, readItem: readSale } = useCollection('sales')

const sale = ref<Sale>(await readSale(props.sale))
sale.value.price = Number(sale.value.price)
...
async function submit() {
  if (props.sale)
    await updateSale(props.sale, sale.value)
  else
